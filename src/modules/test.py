...
class ADS1115():
    ...
    def read_ADC3_V(self) -> float:
        ...
        bitResolution = 32768
        temp = self.read_ADC3()
        print("Counts: " + str(temp))
        return (temp * (fullRange / bitResolution))
    ...
    def read_conversion(self) -> float:
        ...
        while ((value[0] & ADS1115.CONF_REG.OS) != 0):
            value = self.bus.read_i2c_block_data(ADS1115.I2C_ADDRESS, ADS1115.CONF_REG_ADDR, 2)
            time.sleep(.001)
        ...
        print("Conversion: " + str(value))

        return value[0] << 8 | value[1]

s = ADS1115()
print(str(s.read_ADC3_V()) + " volts")
# 133, 131
# 1000 0101, 1000 0011
